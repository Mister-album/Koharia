package koharia.feature.migration.list
...
import koharia.feature.migration.list.components.MigrationExitDialog
import koharia.feature.migration.list.components.MigrationMangaDialog
import koharia.feature.migration.list.components.MigrationProgressDialog
    ...
    override fun Content() {
        ...
        MigrationListScreenContent(
            ...
            onSearchManually = { migrationItem ->
                navigator.push(MangaScreen(migrationItem.manga.id, true))
            },
